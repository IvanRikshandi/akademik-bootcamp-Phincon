...
class OutletCell: UITableViewCell {
    ...
    private func configureAvailabilityLabel(label: UILabel, isAvailable: Bool?, circleImageView: UIImageView, type: String, color: UIColor) {
    ...
    private func parseOperatingHours(_ operatingHours: [OperatingHour], for dayType: Day) -> String? {
